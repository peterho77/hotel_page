export function MultiSelectTag(e, t) {
    ...
    for (var h = 0; h < n.options.length; h++) {
        var g = n.options[h];
        o.push({ id: g.value, label: g.text, preselected: g.selected });
    }
    ((l = document.createElement("div")).className = "multi-select-tag"),
        n.parentNode.insertBefore(l, n.nextSibling);
    for (var m = 0; m < o.length; m++)
        o[m].preselected && f.push({ id: o[m].id, label: o[m].label });
    function E() {
        a.innerHTML = "";
