                ...
                <section class="main-content__right | flow" style="--flow-spacer:1em">
                                                ...
                                                <form method="POST" action="{{ route('room_type.store') }}"
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label for="add_branches"
                                                            ...
                                                            Chi nhánh</label>
                                                        <div class="col-sm-10 col-sm-9 col-lg-8">
                                                            <x-utility.multiple-select-tag id="add-branches"
                                                                :list="$branches" placeholder="Chọn chi nhánh..." />
                                                        </div>
                                                    </div>
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a href="{{ route('room_type.index') }}" class="nav-link active" id="nav-room-type-tab"
                    data-bs-target="#nav-room-type" type="button" role="tab" aria-controls="nav-room-type"
                    aria-selected="true">Hạng phòng
                    </a>
                    </li>
                    <li class="nav-item" role="presentation">
                        <a href={{ route('room.index') }} class="nav-link" id="nav-room-tab" data-bs-target="#nav-room"
                            type="button" role="tab" aria-controls="nav-room-list" aria-selected="false">Danh sách
                            phòng
                        </a>
                    </li>
                    </ul>
                    <div class="tab-content" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="nav-room-type" role="tabpanel"
                            ...
                            <x-utility.data-table id="room-type" :list="$roomTypeList" :columns="$columns" />
                        </div>
                        @else
                        <div class="tab-pane fade show active" id="nav-room" role="tabpanel"
                            aria-labelledby="nav-room-list" tabindex="0">
                            <x-utility.data-table id="room" :list="$roomList" :columns="$columns" />
                        </div>
                        @endif
                    </div> --}}
                    {{-- nav tab bootstrap --}}
                            ...
                            <form method="POST" action="{{ route('room_type.update', "id") }}">
                                ...
                                <div class="mb-3 row">
                                    <label for="update_branches" class="col-sm-2 col-md-3 col-lg-4 col-form-label">
                                        Chi nhánh</label>
                                    <div class="col-sm-10 col-sm-9 col-lg-8">
                                        <x-utility.multiple-select-tag id="update-branches" :list="$branches"
                                            placeholder="Chọn chi nhánh..." />
                                    </div>
                                </div>
