@props(['id' => 'update-item-modal', 'item', 'columns'])

{{-- modal update item --}}
<div class="modal fade" id="{{ $id }}" tabindex="-1" aria-labelledby="update-room-type" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5">Cập nhật hạng phòng
                </h1>
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route($item . '.update', "id") }}">
                    ...
                    @if ($item == "room")
                        <x-utility.single-select-tag label="Room Type" name="room_type_id"
                            :list="$attributes->get('selectList')" />
                    ...
                    @elseif ($item == "room_type")
                        <div class="mb-3 row">
                            <label for="add_branches" class="col-sm-2 col-md-3 col-lg-4 col-form-label">
                                Branch</label>
                            <div class="col-sm-10 col-sm-9 col-lg-8">
                                <x-utility.multiple-select-tag id="update-branch-list" :list="$attributes->get('branchList')" name="branch_id"
